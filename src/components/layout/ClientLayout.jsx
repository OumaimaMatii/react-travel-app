...
import {
  LayoutDashboard, Calendar, Bell, Map, LogOut,
  Menu, X, ChevronRight,
} from 'lucide-react'
...
const NAV = [
  ...
  { to: '/client/reservations', label: 'Mes réservations', icon: Calendar },
  { to: '/client/sur-mesure',   label: 'Voyage sur mesure', icon: Map },
  { to: '/client/notifications', label: 'Notifications',   icon: Bell, badge: true },
]
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full">
      ...
      <div className="px-6 py-5 border-b border-gray-100">
        ...
        <p className="text-xs text-gray-400 mt-0.5">Espace voyageur</p>
      </div>

      {/* User */}
      <div className="px-4 py-4 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <div className="w-9 h-9 bg-secondary/10 rounded-full flex items-center justify-center text-secondary font-bold text-sm">
    ...
    <div className="min-h-screen flex bg-surface">
      ...
      <div className="flex-1 lg:ml-64">
        ...
        <div className="lg:hidden sticky top-0 z-20 bg-white border-b border-gray-100 px-4 py-3 flex items-center gap-3">
          ...
          <p className="font-display font-bold text-primary">VoyageMaroc</p>
        </div>
